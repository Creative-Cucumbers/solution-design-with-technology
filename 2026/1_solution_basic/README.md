...
- [3限目: イントロダクションと自己紹介](#3限目-イントロダクションと自己紹介)
  - [1. コース概要・進め方 (10分)](#1-コース概要進め方-10分)
    ...
    - [1.3 評価の観点](#13-評価の観点)
  - [2. ソリューションとは (25〜30分)](#2-ソリューションとは-2530分)
    - [2.2 様々なソリューション](#22-様々なソリューション)
    - [2.3 現代においてソリューションが重要な理由](#23-現代においてソリューションが重要な理由)
    - [2.4 イノベーションの3つのレンズ](#24-イノベーションの3つのレンズ)
    - [2.5 ソリューションを実現する体制の変化](#25-ソリューションを実現する体制の変化)
  - [3. 自己紹介](#3-自己紹介)
...
これらは、AIが登場する以前からソリューションを考える上で重要だった理由です。「AI時代にどう向き合うか」については、後ほど2.5でさらに深掘りします。
...
先ほど2.5で触れた「少人数チームがAIを活用して大きな成果を生む」という変化は、すでに現実の事例として起き始めています。
