...
### 3.3.1 気になった先端技術についてAIに確認してみよう (10分)
...
### 3.1.5 補足(前回欠席した方向け):  開発環境セットアップ (15分)
...
### 4.1 オセロのアプリを生成AIを用いて開発してみよう

### 4.1.1 オセロアプリ開発手順

```
1. コツを参考にして、生成AIでコードを生成する
2. codeSandbox上でオセロアプリを開発する
3. うまく動かないときはコツを参考にして、開発してみる
4. それでもうまく動かないときは仕組みやコードを理解する
5. 開発できたら、オセロアプリのアーキテクチャを書いてみる
```
...
以下の制約を満たしてください。
制約:
- index.html, server.js, cssの3つのファイルだけで作成してください。
- Node.jsを使用してください。
- データはインメモリデータベースにいれてください。
```

コツ3: 変換するように伝える

コツ4: 動かないときはエラー内容とともに送る
